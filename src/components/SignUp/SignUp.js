        ...
        <div className="sign-in__background">
            <div className="wrapper fadeInDown">
                <div id="formContent">
                    ...
                    <form onSubmit={(event) => registerUser(event, newUser)}>
                        ...
                        <input onChange={handleInputChanges} type="password" id="password" className="sign-in-up-input fadeIn third" name="password" placeholder="password" />
